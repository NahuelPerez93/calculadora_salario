...
function calcularSalario() {
    ...
    // Calcular las horas normales correspondientes a los días faltados
    var horasNormalesFaltadas = diasFaltados * 9;

    // Descuento de horas extras para cubrir las horas normales faltadas
    if (horasExtras >= horasNormalesFaltadas) {
        // Si hay suficientes horas extras, se descuentan completamente las horas normales faltadas
        horasExtras -= horasNormalesFaltadas;
    } else {
        // Si no hay suficientes horas extras, se descuentan parcialmente las horas extras y luego las horas normales restantes
        horasNormalesFaltadas -= horasExtras;
        horasExtras = 0;
        // Calcular horas normales a descontar
        horasTrabajadas -= horasNormalesFaltadas;
    }
    ...
    var resultado = "Horas normales trabajadas: " + (horasTrabajadas > 0 ? horasTrabajadas : 0) + "<br>";
    resultado += "Horas extras trabajadas: " + horasExtras + "<br>";
    resultado += "Horas extras descontadas por días faltados: " + horasNormalesFaltadas + "<br>";
    resultado += "Días faltados: " + diasFaltados + "<br>";
    resultado += "Descuentos: $" + descuentos.toFixed(2) + "<br>";
    resultado += "Salario quincenal total: $" + salarioTotal.toFixed(2);
